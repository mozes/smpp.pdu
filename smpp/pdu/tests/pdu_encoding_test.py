...
class PDUEncoderTest(EncoderTest):
    ...
    def test_DeliverSM_syniverse_MO_conversion(self):
        pdu = DeliverSM(2676551972,
            ...
            source_addr='16508684152',
            dest_addr_ton=AddrTon.INTERNATIONAL,
            dest_addr_npi=AddrNpi.ISDN,
            destination_addr='17738284070',
        ...
        self.do_conversion_test(PDUEncoder(), pdu, '0000004d00000005000000009f88f12441575342440001013136353038363834313532000101313737333832383430373000000000000000000300117468657265206973206e6f2073706f6f6e')
    ...
    def test_DeliverSM_handset_ack_conversion(self):
        ...
        self.do_conversion_test(PDUEncoder(), pdu, '')
    ...
    # def test_blah(self):
    #     pdu = self.decode(PDUEncoder().decode, '000000470000000500000000737bf0564d4554524f0001013136373835303934333237000101313537313733303631383400000000000000000000000204000200010201000100')
    #     print pdu
